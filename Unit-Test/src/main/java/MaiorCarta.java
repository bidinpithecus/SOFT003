...
public class MaiorCarta {
  ...
  public int getSuasVitorias() {
    return suasVitorias;
  }

  public void setSuasVitorias(int suasVitorias) {
    this.suasVitorias = suasVitorias;
  }

  public int getMinhasVitorias() {
    return minhasVitorias;
  }

  public void setMinhasVitorias(int minhasVitorias) {
    this.minhasVitorias = minhasVitorias;
  }
